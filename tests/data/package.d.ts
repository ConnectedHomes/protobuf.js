...
export class Package implements IPackage {
    ...
    public static _toObject(message: Package, options?: $protobuf.IConversionOptions): { [k: string]: any };
...
export namespace Package {
    ...
    class Repository implements IRepository {
        ...
        public static _toObject(message: Package.Repository, options?: $protobuf.IConversionOptions): { [k: string]: any };
