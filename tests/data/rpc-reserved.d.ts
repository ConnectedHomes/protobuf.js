...
export class MyRequest implements IMyRequest {
    ...
    public static _toObject(message: MyRequest, options?: $protobuf.IConversionOptions): { [k: string]: any };
...
export class MyResponse implements IMyResponse {
    ...
    public static _toObject(message: MyResponse, options?: $protobuf.IConversionOptions): { [k: string]: any };
